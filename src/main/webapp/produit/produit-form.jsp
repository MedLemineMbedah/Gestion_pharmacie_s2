			...
			<div class="card-body">
              ...
              <c:if test="${produit != null}">
				...
				<div class="form-group">
                    ...
                    <input type="number" class="form-control" name="quantite" value="" required="required"  id="exampleInputEmail1" placeholder="Quantite"disabled>
                </div>
				
				
				<div class="form-group">
                    <label for="exampleInputEmail1">Prix</label>
                    <input type="number" class="form-control" name="prix" value="" required="required"  id="exampleInputEmail1" placeholder="prix"disabled>
                </div>
				</div>
				<div class="form-group">
